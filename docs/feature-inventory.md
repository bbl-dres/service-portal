...
- Bearbeitungsmodus: Der Zustandsindikator steht mittig in der primären App-Kopfzeile. Die wireframegetreue Werkzeugleiste trennt «Hinzufügen», Auswahl, Messung, Strukturbearbeitung und Verlauf. «Hinzufügen» öffnet die Produkt-/Modulbibliothek kontextuell; eine Produktwahl wechselt mit freiem Canvas in die Platzierung, bei bereits gewähltem Raum platziert sie direkt, eine Modulzuweisung schliesst die Bibliothek nach Erfolg. Produkte lassen sich mit gültiger/ungültiger Vorschau setzen, ziehen, per Koordinaten oder Tastatur verschieben, in 45°-Schritten drehen und entfernen; der vollständige gedrehte Footprint muss im Geschoss bleiben. Raumnutzung, SIA-Klasse, Verwaltungseinheit, Kapazität, Nummer, Bezeichnung und Reservierbarkeit sind pflegbar. Das Strukturmenü kennzeichnet die noch nicht implementierten CAD-Werkzeuge deaktiviert und bietet die tatsächlich vorhandene rechteckige Feedback-Fläche sowie einen wirksamen Geometrie-Lock. Flächen lassen sich entsperrt anlegen, verschieben und an acht Griffen oder über X/Y/Breite/Tiefe skalieren; positive Raumüberlappungen und atomar ungültige Raum-/Objektverschiebungen werden verworfen. Rückgängig/Wiederholen verwendet einen begrenzten Verlauf.
