...
const CASES = [
  ...
  { route: '/knowledge/workspace/inspiration/bundeshaus-west-2og-stabsstelle',
    tracked: KNOWLEDGE_FILES, want: ['media.json', 'workspace-examples.json'] },
  { route: '/knowledge/workspace/inspiration/gibt-es-nicht', tracked: KNOWLEDGE_FILES,
    want: ['media.json', 'workspace-examples.json'], title: 'Seite nicht gefunden' },
