...
const VIEWS = [
  { name: 'portfolio (Bundeshaus West)', url: `${APP_BASE}/app/portfolio?id=${encodeURIComponent('1000/4840/AF')}`, tabs: ['uebersicht', 'bauprojekte', 'dokumente', 'medien'], hashSync: false },
